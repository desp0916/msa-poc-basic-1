...
const KeywordTaskForm = Loadable({
  loader: () => import('../form/KeywordTaskForm'),
  loading: Loading,
...
export default class KeywordTaskPage extends Component {

  constructor(props) {
    super(props);
    this.repository = 'keywordmonitortasks';
    this.pageTitle = '關鍵字監控排程管理';
    ...
    this.detailPath = '/KeywordTask/KeywordTaskForm';
  ...
  render() {
    ...
    return (
      <div>
        <Switch>
          <Route path={`${this.detailPath}/${Globals.ACT_CREATE}`} render={(props) => (<KeywordTaskForm {...props} act={Globals.ACT_CREATE} />)}/>
          <Route path={`${this.detailPath}/:itemId`} render={(props) => (<KeywordTaskForm {...props} act={Globals.ACT_UPDATE} />)}/>
        </Switch>

...
export default class KeywordTaskRecordPage extends Component {
  ...
  constructor(props) {
    ...
    this.repository = 'keywordmonitortaskrecords';
    this.pageTitle = '關鍵字監控排程通知紀錄';
    this.dialogTitle = '檢視關鍵字監控排程通知紀錄';
    ...
    this.searchOptions = [
      ...
      {key: 'findByTaskIdForCurrentUser', value: '關鍵字監控排程ID' },
    ];

    this.detailColumn = 'id';
    this.detailPath = '/KeywordTaskRecord/KeywordTaskRecordView';
  ...
  componentDidMount() {
    ...
    stompClient.register([
			{route: '/topic/newKeywordMonitorTask', callback: this._handleRefreshList},
			{route: '/topic/updateKeywordMonitorTask', callback: this._handleRefreshList},
			{route: '/topic/deleteKeywordMonitorTask', callback: this._handleRefreshList}
    ]);
  }

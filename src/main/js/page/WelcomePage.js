...
const ArticleView = Loadable({
  loader: () => import('../form/ArticleView'),
  loading: Loading,
});
...
export default class WelcomePage extends React.Component {
  ...
  constructor(props) {
    ...
    this.detailPath = '/Welcome/ArticleView';
  ...
  componentDidMount() {
    ...
    stompClient.register([
      {route: '/topic/newArticle', callback: this._handleRefreshList},
      {route: '/topic/updateArticle', callback: this._handleRefreshList},
      {route: '/topic/deleteArticle', callback: this._handleRefreshList}
    ]);
  }
  ...
  render() {
    ...
    return (
      <div>
        <Switch>
          <Route path={`${this.detailPath}/:itemId`} render={(props) => (<ArticleView {...props} act={Globals.ACT_VIEW} />)}/>
        </Switch>
